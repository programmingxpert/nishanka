...
const baubleSchema = new Schema({
    ...
    workJobsCompleted: { type: Number, default: 0 },
    deliveriesCompleted: { type: Number, default: 0 },
    ghostsCaptured: { type: Number, default: 0 },
    aliensTranslated: { type: Number, default: 0 },
    dragonsHandled: { type: Number, default: 0 },
    customersServed: { type: Number, default: 0 },
    bombsDefused: { type: Number, default: 0 },
    mysteriesSolved: { type: Number, default: 0 },
    treasuresRecovered: { type: Number, default: 0 },
    bagsHandled: { type: Number, default: 0 },
    arcadeRepairs: { type: Number, default: 0 },
    trainsConducted: { type: Number, default: 0 },
    inspectionsSurvived: { type: Number, default: 0 },
