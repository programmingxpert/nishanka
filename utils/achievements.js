...
const ACHIEVEMENTS = [
    ...
    { id: 'minesweeper_demigod', name: 'Minesweeper Demigod', emoji: '⚡', description: 'Win a Mines game with 13 mines without hitting a single trap.', rarity: 0.2, isAward: true, isBadge: false, category: 'mines' },
    ...
    { id: 'active_180', name: 'Half-Year Devotion', emoji: '📅', description: 'Maintain a daily streak for 180 days straight.', rarity: 0.1, isAward: true, isBadge: false, category: 'streaks' },
    ...
    { id: 'slots_jackpot', name: 'Jackpot Winner', emoji: '💎', description: 'Roll the 3x triple Premium Gem jackpot on Slots.', rarity: 0.5, isAward: true, isBadge: false, category: 'casino' },
    ...
    { id: 'coinflip_streak_15', name: 'Coinflip Legend', emoji: '🔱', description: 'Win 15 Coinflip games in a row.', rarity: 0.1, isAward: true, isBadge: false, category: 'casino' },
    { id: 'coinflip_streak_20', name: 'Coinflip Overlord', emoji: '👑', description: 'Win 20 Coinflip games in a row.', rarity: 0.05, isAward: true, isBadge: false, category: 'casino' },
    { id: 'slots_jackpot_triple', name: 'Triple Glimmer Jackpot', emoji: '🔮', description: 'Win the Slots jackpot 3 times in total.', rarity: 0.05, isAward: true, isBadge: false, category: 'casino' },
    ...
    // Economy & Relics
    { id: 'coinflip_streak_10', name: 'Coinflip Champion', emoji: '🥇', description: 'Win 10 Coinflip games in a row.', rarity: 1, isAward: true, isBadge: false, category: 'economy' },
    { id: 'economy_millionaire', name: 'Bauble Tycoon', emoji: '👑', description: 'Amass 1,000,000 Baubles in your wallet balance.', rarity: 0.2, isAward: true, isBadge: false, category: 'economy' },
    { id: 'economy_billionaire', name: 'Bauble Oligarch', emoji: '🏛️', description: 'Amass 5,000,000 Baubles in your wallet balance.', rarity: 0.05, isAward: true, isBadge: false, category: 'economy' },
    { id: 'tax_evader', name: 'Tax Dodger', emoji: '🥷', description: 'Pay a cumulative total of 50,000 Baubles in daily wealth taxes.', rarity: 1, isAward: true, isBadge: false, category: 'economy' },
    { id: 'tax_tycoon', name: 'Tax Tycoon', emoji: '🎩', description: 'Pay a cumulative total of 250,000 Baubles in daily wealth taxes.', rarity: 0.1, isAward: true, isBadge: false, category: 'economy' },
    ...
    { id: 'scavenge_legend', name: 'Relic Hunter', emoji: '🏺', description: 'Discover a Mythic or Unique item while scavenging.', rarity: 0.1, isAward: true, isBadge: false, category: 'economy' },
    { id: 'relic_collector', name: 'Museum Curator', emoji: '🏺', description: 'Collect 10 unique relics/items in your inventory.', rarity: 0.5, isAward: true, isBadge: false, category: 'economy' },

    // Insanely Hard Achievements
    { id: 'mines_perfect_10', name: 'Legendary Mine Clearer', emoji: '🌌', description: 'Clear a 10-mines grid perfectly (reveal all 6 safe gems).', rarity: 0.01, isAward: true, isBadge: false, category: 'mines' },
    { id: 'mines_perfect_8', name: 'Unmineable Titan', emoji: '🪐', description: 'Clear an 8-mines grid perfectly (reveal all 8 safe gems).', rarity: 0.005, isAward: true, isBadge: false, category: 'mines' },
    { id: 'streak_500', name: 'Centennial Legend', emoji: '🌋', description: 'Maintain a daily streak for 500 days straight.', rarity: 0.01, isAward: true, isBadge: false, category: 'streaks' },
    ...
    { id: 'blackjack_500', name: 'Blackjack Overlord', emoji: '🃏', description: 'Win 500 Blackjack games.', rarity: 0.01, isAward: true, isBadge: false, category: 'casino' },
    { id: 'economy_emperor', name: 'Bauble Emperor', emoji: '👑', description: 'Amass 10,000,000 Baubles in your wallet balance.', rarity: 0.01, isAward: true, isBadge: false, category: 'economy' },
    ...
    { id: 'tax_emperor', name: 'Nishanka Sponsor', emoji: '💼', description: 'Pay a cumulative total of 1,000,000 Baubles in daily wealth taxes.', rarity: 0.01, isAward: true, isBadge: false, category: 'economy' },
    { id: 'relic_sovereign', name: 'Relic Sovereign', emoji: '🏺', description: 'Collect 20 unique relics/items in your inventory.', rarity: 0.05, isAward: true, isBadge: false, category: 'economy' },
    { id: 'work_legend', name: 'CEO of Nishanka', emoji: '🏢', description: 'Complete 5,000 work jobs in total.', rarity: 0.01, isAward: true, isBadge: false, category: 'economy' },
    ...
    { id: 'scavenge_mythic_5', name: 'Archeology Titan', emoji: '⚜️', description: 'Hold 5 or more Mythic or Unique items in your inventory.', rarity: 0.01, isAward: true, isBadge: false, category: 'economy' },

    // Creative & Cross-Mechanic Achievements
    { id: 'jack_of_all_trades', name: 'Jack of All Trades', emoji: '🃏', description: 'Win a game of Slots, Blackjack, Gamble, Coinflip, AND Mines all on the same calendar day.', rarity: 0.05, isAward: true, isBadge: false, category: 'casino' },
    ...
    { id: 'crime_lord', name: 'Crime Lord', emoji: '🕵️', description: 'Pull off 300 consecutive successful crimes without getting arrested once.', rarity: 0.01, isAward: true, isBadge: false, category: 'economy' },
    { id: 'master_heist', name: 'The Phantom Thief', emoji: '🦹', description: 'Successfully complete 50 High-Stakes Heist robberies.', rarity: 0.05, isAward: true, isBadge: false, category: 'economy' },
    { id: 'overtime_grinder', name: 'Overtime Legend', emoji: '⏰', description: 'Complete 30 work jobs in a single calendar day.', rarity: 0.1, isAward: true, isBadge: false, category: 'economy' },
    ...
    { id: 'scramble_win_50', name: 'Word Whisperer', emoji: '🗣️', description: 'Win 50 Scramble games.', rarity: 1.0, isAward: true, isBadge: false, category: 'minigames' },
    { id: 'scramble_win_100', name: 'Word Sorcerer', emoji: '🏁', description: 'Win 100 Anagram Scramble games.', rarity: 0.1, isAward: true, isBadge: false, category: 'minigames' },
    { id: 'scramble_win_250', name: 'Dictionary Emperor', emoji: '🏁', description: 'Win 250 Anagram Scramble games.', rarity: 0.01, isAward: true, isBadge: false, category: 'minigames' },
    ...
    { id: 'wordbomb_win_50', name: 'Vocabulary Nuke', emoji: '💥', description: 'Win 50 Word Bomb games.', rarity: 0.5, isAward: true, isBadge: false, category: 'minigames' },
    { id: 'wordbomb_win_100', name: 'The Lexicon Legend', emoji: '💣', description: 'Win 100 Word Bomb games.', rarity: 0.05, isAward: true, isBadge: false, category: 'minigames' },
    { id: 'wordbomb_win_250', name: 'Nuclear Thesaurus', emoji: '💣', description: 'Win 250 Word Bomb games.', rarity: 0.005, isAward: true, isBadge: false, category: 'minigames' },
    ...
    { id: 'coinflip_win_1000', name: 'Oracle of the Flip', emoji: '🪙', description: 'Win 1,000 Coinflip games in total.', rarity: 0.05, isAward: true, isBadge: false, category: 'casino' },
    ...
    { id: 'gamble_win_250', name: 'Gamble Grandmaster', emoji: '🎲', description: 'Win 250 Gamble games.', rarity: 0.5, isAward: true, isBadge: false, category: 'casino' },
    { id: 'gamble_win_1000', name: 'Casino Overlord', emoji: '🎲', description: 'Win 1,000 Gamble games.', rarity: 0.02, isAward: true, isBadge: false, category: 'casino' },
    ...
    { id: 'slots_win_250', name: 'Slots Virtuoso', emoji: '🎰', description: 'Win 250 Slots games.', rarity: 0.5, isAward: true, isBadge: false, category: 'casino' },
    { id: 'slots_win_1000', name: 'One-Armed Bandit', emoji: '🎰', description: 'Win 1,000 Slots games.', rarity: 0.02, isAward: true, isBadge: false, category: 'casino' },
    ...
    { id: 'blackjack_win_250', name: 'Blackjack Master', emoji: '🃏', description: 'Win 250 Blackjack games.', rarity: 1.0, isAward: true, isBadge: false, category: 'casino' },
    ...
    { id: 'rob_attempt_1000', name: 'Public Menace', emoji: '🚨', description: 'Attempt 1,000 robberies in total.', rarity: 0.05, isAward: true, isBadge: false, category: 'economy' },
    ...
    { id: 'rob_success_50', name: 'Grand Larcenist', emoji: '🏦', description: 'Successfully rob other players 50 times.', rarity: 1.0, isAward: true, isBadge: false, category: 'economy' },
    { id: 'rob_success_100', name: 'Master Thief', emoji: '🥷', description: 'Successfully rob other players 100 times.', rarity: 0.5, isAward: true, isBadge: false, category: 'economy' },
    ...
    { id: 'heist_success_100', name: 'Ocean\'s Eleven', emoji: '🦹', description: 'Successfully complete 100 High-Stakes Heist robberies.', rarity: 0.01, isAward: true, isBadge: false, category: 'economy' },
    { id: 'rob_jackpot', name: 'The Heist of a Century', emoji: '💎', description: 'Trigger an extremely rare Jackpot Robbery and bypass normal steal limits!', rarity: 0.05, isAward: true, isBadge: true, category: 'economy' },
    { id: 'rob_millionaire', name: 'Federal Reserve Cleared', emoji: '🏦', description: 'Successfully steal 1,000,000 or more Baubles in a single robbery.', rarity: 0.01, isAward: true, isBadge: true, category: 'economy' },
    { id: 'rob_half_millionaire', name: 'Half-Million Heist', emoji: '💸', description: 'Successfully steal 500,000 or more Baubles in a single robbery.', rarity: 0.1, isAward: true, isBadge: false, category: 'economy' },
    ...
    { id: 'crime_success_200', name: 'Mobster', emoji: '🕶️', description: 'Successfully commit 200 crimes in total.', rarity: 1.0, isAward: true, isBadge: false, category: 'economy' },
    { id: 'crime_success_500', name: 'Crime Syndicate Boss', emoji: '🥷', description: 'Successfully commit 500 crimes in total.', rarity: 0.05, isAward: true, isBadge: false, category: 'economy' },
