...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('handshake')
		.setDescription('handshake someone through the screen!')
		.addUserOption(option =>
			option.setName('user')
				.setDescription('The user you want to handshake')
				.setRequired(true))
		.addStringOption(option =>
			option.setName('message')
				.setDescription('An optional message to send with your handshake')),
	...
	async execute(context) {
		...
		if (!user) return context.reply('❗ Please mention a user to handshake.');
