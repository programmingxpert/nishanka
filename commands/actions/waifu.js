...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('waifu')
        .setDescription('make any user your waifu :3')
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user you want to waifu')
                .setRequired(true))
        .addStringOption(option =>
            option.setName('message')
                .setDescription('An optional message to send with your waifu')),
    ...
    async execute(context) {
        ...
        if (!user) return context.reply('❗ Please mention a user to waifu.');
