...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('kiss')
		.setDescription('kiss someone through the screen!')
		...
		.addStringOption(option =>
			option.setName('message')
				.setDescription('An optional message to send with your kiss')),
	...
	async execute(context) {
		...
		if (!user) return context.reply('❗ Please mention a user to kiss.');
