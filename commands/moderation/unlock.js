...
module.exports = {
	...
	async execute(interaction) {
		...
		try {
			...
			console.error(error);
			await interaction.reply({ content: `❌ Failed to unlock channel ${targetChannel}. Make sure I have "Manage Roles" permission.`, ephemeral: true });
		}
	},
	...
	async executePrefix(message, args) {
		...
		try {
			...
			console.error(error);
			await message.reply(`❌ Failed to unlock channel ${targetChannel}. Make sure I have "Manage Roles" permission.`);
		}
	}
};
